...
@InitiatedBy(CbioRedeemFlowInitiator.class)
public class CbioRedeemFlowResponder extends FlowLogic<Void> {
    ...
    public CbioRedeemFlowResponder(FlowSession anpSession) {
    ...
    public Void call() throws FlowException {
        ...
        if (!ANP.getName().equals(Constants.ANP)) {
            throw new FlowException("Only ANP can redeem CBIOS");
        }
