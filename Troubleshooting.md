...
* `java.io.NotSerializableException: net.corda.core.cbio.contracts.TransactionState -> data(net.corda.core.cbio.contracts.ContractState) -> Constructor parameter - "arg0" -  doesn't refer to a property of "class java_bootcamp.TokenState" -> class java_bootcamp.TokenState`
