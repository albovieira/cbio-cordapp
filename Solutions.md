...
```java
    ...
    import net.corda.core.cbio.contracts.BelongsToContract;
    import net.corda.core.cbio.contracts.ContractState;
     ...
     * See src/main/java/api/ArtState.java for an example. */
...
```java
    ...
    import net.corda.core.cbio.contracts.CommandData;
    import net.corda.core.cbio.contracts.CommandWithParties;
    import net.corda.core.cbio.contracts.Contract;
    import net.corda.core.cbio.contracts.ContractState;
    import net.corda.core.transactions.LedgerTransaction;
    
    import java.util.List;
    
    import static net.corda.core.cbio.contracts.ContractsDSL.requireSingleCommand;
    import static net.corda.core.cbio.contracts.ContractsDSL.requireThat;
